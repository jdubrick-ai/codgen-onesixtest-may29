...
3) Access the `workbench` named `codgen-onesixtest-may29-notebook`.
...
5) In the terminal, run `cd codgen-onesixtest-may29` to navigate to your sample app's directory.
